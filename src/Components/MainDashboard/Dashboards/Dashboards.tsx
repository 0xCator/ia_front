    ...
    import { Button, Container, Paper, Box, Grid, Typography, Divider } from '@mui/material';
...
return (
    ...
    <Grid xs={12} sm={8} md={5} component={Paper} elevation={6} padding={1}>
        <Grid container sx={{padding:1}}>
            ...
            <Grid xs={1}>
                <Button variant="contained" color="primary" onClick={() => setShowAddProjectForm(true)}>New Project</Button>
            </Grid>
        </Grid>  
        <Divider />
